...
const DealTasks = () => {
    ...
    <div className="task-stats-cards">
      <div className="stats-card">
        ...
        <div className="stats-card-content">
          ...
          <span className="stats-card-label">Total Tasks</span>
        </div>
      </div>
      <div className="stats-card">
        ...
        <div className="stats-card-content">
          <span className="stats-card-value">{stats.completed}</span>
      ...
      <div className="stats-card">
        ...
        <div className="stats-card-content">
          <span className="stats-card-value">{stats.pending}</span>
          <span className="stats-card-label">Pending</span>
        </div>
      </div>
      <div className="stats-card">
        <div className="stats-card-icon overdue">
          <AlertCircle size={20} />
        </div>
        <div className="stats-card-content">
          <span className="stats-card-value">{stats.overdue}</span>
    ...
    <div className="filter-actions-panel">
      <div className="filter-row">
        <div className="filter-group">
          <label>Deal</label>
          <select value={filters.deal} onChange={(e) => setFilters({ ...filters, deal: e.target.value })}>
      ...
      <div className="filter-row">
        ...
        <div className="filter-actions-btns">
          <button className="btn btn-primary" onClick={() => setShowFilters(false)}>Apply Filter</button>
  ...
  return (
    <div className="enquiries-page">
      <PageHeader title="Deal Task" description="Manage deal-specific tasks and follow-ups." />
          ...
          <div className="dropdown-container">
            ...
            {showSortDropdown && (
              <div className="sort-dropdown">
                <button onClick={() => { handleSort('scheduledDate'); setShowSortDropdown(false); }}>
                  Scheduled Date {sortConfig.key === 'scheduledDate' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
                </button>
                <button onClick={() => { handleSort('title'); setShowSortDropdown(false); }}>
                  Title {sortConfig.key === 'title' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
                </button>
                <button onClick={() => { handleSort('status'); setShowSortDropdown(false); }}>
                  ...
                  <div className="action-menu-container">
                    ...
                    {actionMenuOpen === row.id && (
                      <div className="action-dropdown">
                        ...
                        <button onClick={() => handleEditTask(row)}><Edit2 size={14} /> Edit Task</button>
