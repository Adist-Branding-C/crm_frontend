...
return React.createElement(PageContainer, { className: 'sp-detail-page' },
      React.createElement(Link, { to: '/staff-performance', className: 'back-link' }, 
        React.createElement(ArrowLeft, { size: 18 }), ' Back to Staff List'
      ),

      React.createElement('div', { className: 'profile-section' },
        React.createElement('div', { className: 'profile-avatar' }, staff.name.charAt(0)),
        React.createElement('div', { className: 'profile-info' },
          React.createElement('h1', { className: 'profile-name' }, staff.name),
          React.createElement('p', { className: 'profile-role' }, staff.role),
          React.createElement('div', { className: 'contact-info' },
            React.createElement('span', null, React.createElement(Mail, { size: 14 }), ' ', staff.email),
            React.createElement('span', null, React.createElement(Phone, { size: 14 }), ' ', staff.phone),
            React.createElement('span', null, React.createElement(Users, { size: 14 }), ' ', staff.department),
            React.createElement('span', null, React.createElement(Calendar, { size: 14 }), ' Joined ', staff.joinDate)
          )
        ),
        React.createElement('div', { className: 'rating-badge' },
          React.createElement('div', { className: 'rating-value' }, staff.rating),
          React.createElement('div', { className: 'rating-label' }, 'Rating')
        )
      ),
      
      React.createElement('div', { className: 'stats-grid' },
        React.createElement(KpiCard, { title: 'Total Leads', value: staff.totalLeads, isPrimary: true }),
        React.createElement(KpiCard, { title: 'Converted', value: staff.converted, isPrimary: true }),
        React.createElement(KpiCard, { title: 'Conversion Rate', value: conversionRate + '%', isPrimary: true }),
        React.createElement(KpiCard, { title: 'Revenue', value: '$' + staff.revenue.toLocaleString(), isPrimary: true })
      ),
      
      React.createElement('div', { className: 'performance-table-section' },
        React.createElement('div', { className: 'section-header' },
          React.createElement('h2', { className: 'section-title' }, 'Performance Metrics'),
          React.createElement('div', { className: 'filter-wrapper', ref: detailFilterRef },
            ...
            detailShowFilters && React.createElement('div', { className: 'filter-dropdown' },
              React.createElement('div', { className: 'filter-header' },
                React.createElement('span', null, 'Filter by Date'),
                React.createElement('button', { 
                  className: 'clear-btn',
        ...
        React.createElement('table', { className: 'performance-table' },
          ...
          React.createElement('tbody', null,
            React.createElement('tr', null,
              React.createElement('td', null, 'Total Leads'),
              React.createElement('td', null, staff.totalLeads)
            ),
            React.createElement('tr', null,
              React.createElement('td', null, 'Converted Leads'),
              React.createElement('td', null, staff.converted)
            ),
            React.createElement('tr', null,
              React.createElement('td', null, 'Conversion Rate'),
              React.createElement('td', null, conversionRate + '%')
            ),
            React.createElement('tr', null,
              React.createElement('td', null, 'Deals Closed'),
              React.createElement('td', null, staff.deals)
            ),
            React.createElement('tr', null,
              React.createElement('td', null, 'Total Revenue'),
              React.createElement('td', null, '$' + staff.revenue.toLocaleString())
            ),
            React.createElement('tr', null,
              React.createElement('td', null, 'Avg Deal Value'),
              React.createElement('td', null, '$' + avgDealValue.toLocaleString())
            ),
            React.createElement('tr', null,
              React.createElement('td', null, 'Completed Tasks'),
              React.createElement('td', null, staff.completedTasks)
            ),
            React.createElement('tr', null,
              React.createElement('td', null, 'Pending Tasks'),
              React.createElement('td', null, staff.pendingTasks)
            ),
            React.createElement('tr', null,
              React.createElement('td', null, 'Task Completion'),
              React.createElement('td', null, taskCompletion + '%')
            ),
            React.createElement('tr', null,
              React.createElement('td', null, 'Calls Made'),
              React.createElement('td', null, staff.calls)
            ),
            React.createElement('tr', null,
              React.createElement('td', null, 'Emails Sent'),
              React.createElement('td', null, staff.emails)
            ),
            React.createElement('tr', null,
              React.createElement('td', null, 'Meetings'),
              React.createElement('td', null, staff.meetings)
            ),
            React.createElement('tr', null,
              React.createElement('td', null, 'Follow-ups'),
              React.createElement('td', null, staff.followups)
            )
          )
        )
      ),
      ...
      React.createElement('div', { className: 'activity-section' },
        React.createElement('h2', { className: 'section-title' }, 'Recent Activity'),
          ...
          recentActivities.map(activity => 
            React.createElement('div', { key: activity.id, className: 'activity-item' },
              React.createElement('div', { className: 'activity-icon' },
                activity.type === 'call' ? React.createElement(PhoneCall, { size: 16 }) :
              ...
              React.createElement('div', { className: 'activity-content' },
                ...
                React.createElement('div', { className: 'activity-time' }, activity.time)
              )
            )
          )
        )
  ...
  return React.createElement(PageContainer, { className: 'sp-page' },
    ...
    React.createElement('div', { className: 'toolbar' },
      React.createElement('div', { className: 'toolbar-left' },
        ...
        React.createElement('div', { className: 'filter-wrapper', ref: filterRef },
          React.createElement('button', { 
    ...
    React.createElement('div', { className: 'staff-grid' },
      filteredStaff.map(s => 
        React.createElement(Link, { key: s.id, to: '/staff-performance/' + s.id, className: 'staff-card' },
          React.createElement('div', { className: 'staff-card-avatar' }, s.name.charAt(0)),
          React.createElement('div', { className: 'staff-card-info' },
            React.createElement('div', { className: 'staff-card-name' }, s.name),
            React.createElement('div', { className: 'staff-card-role' }, s.role)
          ),
          React.createElement('div', { className: 'staff-card-stats' },
            React.createElement('div', { className: 'staff-stat' },
              React.createElement('span', null, s.totalLeads),
              React.createElement('label', null, 'Leads')
            ),
            React.createElement('div', { className: 'staff-stat' },
              React.createElement('span', null, s.converted),
              React.createElement('label', null, 'Converted')
            ),
            React.createElement('div', { className: 'staff-stat' },
              React.createElement('span', null, s.rating),
