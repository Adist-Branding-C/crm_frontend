...
const DesignationPage = () => {
    ...
    const filteredData = designationData.filter(item => item.name.toLowerCase().includes(searchQuery.toLowerCase()));
