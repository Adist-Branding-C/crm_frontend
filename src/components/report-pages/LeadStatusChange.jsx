...
import { 
  ...
  UserCheck, MoreHorizontal, ArrowLeft
} from 'lucide-react';
        ...
        <div className="filters-panel">
          <form id="getReport" onSubmit={handleSubmit}>
            <div className="filter-row">
              ...
              <div className="filter-group">
                <label>Status</label>
                <select value={filters.status} onChange={(e) => setFiltersState({ ...filters, status: e.target.value })}>
              ...
              <div className="filter-group">
                ...
                <select value={filters.leadSource} onChange={(e) => setFiltersState({ ...filters, leadSource: e.target.value })}>
