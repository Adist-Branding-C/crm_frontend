          ...
          <form id="getReport" onSubmit={handleSubmit}>
            <div className="filter-row">
              <div className="filter-group">
                ...
                <input type="date" value={filters.fromDate} onChange={(e) => setFiltersState({ ...filters, fromDate: e.target.value })} />
              </div>
              <div className="filter-group">
                <label>To Date</label>
                <input type="date" value={filters.toDate} onChange={(e) => setFiltersState({ ...filters, toDate: e.target.value })} />
              </div>
              <div className="filter-group">
                <label>Select Staff</label>
                <select value={filters.staffId} onChange={(e) => setFiltersState({ ...filters, staffId: e.target.value })}>
