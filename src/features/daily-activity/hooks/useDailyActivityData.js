...
export const useDailyActivityData = () => {
    ...
    const fetchActivities = useCallback(async (page, f, at) => {
        const requestSeq = ++requestSeqRef.current;
        try {
            const params = { pageNumber: page, limit: rowsPerPage };
            if (f.date)
                params.date = f.date;
            if (f.startTime)
...
//# sourceMappingURL=useDailyActivityData.js.map