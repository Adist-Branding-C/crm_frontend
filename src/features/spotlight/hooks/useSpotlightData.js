...
export function useSpotlightData() {
    ...
    const requestParams = useMemo(() => {
        ...
        if (filters.leadTypeId)
            params.leadTypeId = filters.leadTypeId;
        ...
        if (filters.leadStatusId)
            params.leadStatusId = filters.leadStatusId;
        ...
        if (filters.filterByDate)
            params.dateFilterBy = filters.filterByDate;
        return params;
    ...
    const paginatedIds = useMemo(() => data.map(item => item.id), [data]);
...
//# sourceMappingURL=useSpotlightData.js.map