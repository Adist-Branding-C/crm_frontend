...
import LeadSettingsSidebar from '../../lead-settings/components/LeadSettingsSidebar';
import { useLeadPipelineList } from '../hooks/useLeadPipelineList';
  ...
  return (
    <div className="lead-settings-page">
      <PageHeader
        ...
        description="Design the stages a lead moves through"
        action={
      ...
      <div className="settings-content">
        ...
        {!isLoading && pipelines.length === 0 ? (
          <p className="lead-pipeline-list-empty">No pipelines yet - create one to get started.</p>
        ) : (
          <div className="lead-pipeline-list-grid">
...
export default LeadPipelineListPage;
