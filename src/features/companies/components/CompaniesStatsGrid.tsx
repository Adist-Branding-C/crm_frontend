...
const CompaniesStatsGrid: React.FC<CompaniesStatsGridProps> = React.memo(({ stats }) => (
  <div className="company-stats-grid">
    <div className="company-stat-card">
      <div className="company-stat-icon" style={{ background: '#3b82f620' }}><Building size={20} color="var(--info)" /></div>
    ...
    <div className="company-stat-card">
      <div className="company-stat-icon" style={{ background: '#ef444420' }}><AlertCircle size={20} color="var(--danger)" /></div>
      <div className="company-stat-info">
    ...
    <div className="company-stat-card">
      <div className="company-stat-icon" style={{ background: '#f59e0b20' }}><Clock size={20} color="var(--warning)" /></div>
      <div className="company-stat-info">
    ...
    <div className="company-stat-card">
      <div className="company-stat-icon" style={{ background: '#8b5cf620' }}><Users size={20} color="var(--category-purple-text)" /></div>
      <div className="company-stat-info">
    ...
    <div className="company-stat-card">
      <div className="company-stat-icon" style={{ background: '#10b98120' }}><DollarSign size={20} color="var(--success)" /></div>
      <div className="company-stat-info">
