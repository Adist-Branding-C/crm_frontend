...
import type { LeadTypeFormProps } from '../types/lead-type-form.types';

const LeadTypeForm = ({ form, status }: LeadTypeFormProps) => {
          ...
          <div ref={formBodyRef}>
            <Form>
              ...
              <div className="form-group">
                <label>{LEAD_TYPE_FIELD_LABEL} <span className="text-danger">*</span></label>
                <Field type="text" name="type" className={fieldClass('type')} placeholder={LEAD_TYPE_FIELD_PLACEHOLDER} />
                {showError('type') && errors.type && <small className="field-error-text">{errors.type}</small>}
              </div>
