...
import { useLeadTypesPagination } from './useLeadTypesPagination';
import { useLeadTypesCrud } from './useLeadTypesCrud';
import { useLeadTypesForm } from './useLeadTypesForm';
import { useLeadTypesToast } from './useLeadTypesToast';
...
export function useLeadTypesData() {
  ...
  const pagination = useLeadTypesPagination(crud.fetchData);
  ...
  const form = useLeadTypesForm({
    items: crud.items,
    fetchData: crud.fetchData,
    createType: crud.createType,
    updateType: crud.updateType,
