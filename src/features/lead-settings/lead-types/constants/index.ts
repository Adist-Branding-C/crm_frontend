 ...
 */
export const EMPTY_LEAD_TYPE_FORM_DATA: LeadTypeFormData = { type: '' };
 ...
 */
export const LEAD_TYPE_FIELD_MAP: FieldErrorMap = {
  type: 'type',
};
 ...
 * - useLeadTypeCrud (create/update lead type error handling, via shared applyFieldErrors)
 */
export const LEAD_TYPE_FIELD_ERROR_FALLBACKS: FieldErrorFallback[] = [
