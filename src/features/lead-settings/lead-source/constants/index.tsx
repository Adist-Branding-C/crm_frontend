 ...
 */
export const EMPTY_LEAD_SOURCE_FORM_DATA: LeadSourceFormData = { source: '' };
 ...
 */
export const LEAD_SOURCE_FIELD_MAP: FieldErrorMap = {
  source: 'source',
};
 ...
 * - useLeadSourceCrud (create/update lead source error handling, via shared applyFieldErrors)
 */
export const LEAD_SOURCE_FIELD_ERROR_FALLBACKS: FieldErrorFallback[] = [
