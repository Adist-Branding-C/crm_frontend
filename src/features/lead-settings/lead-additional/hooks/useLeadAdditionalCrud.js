 ...
 */
export function useLeadAdditionalCrud({ table }) {
    ...
    const handleCreateAdditionalField = useCallback(async (values, { setSubmitting, resetForm, setFieldError }) => {
    ...
    const handleUpdateAdditionalField = useCallback(async (id, values, { setSubmitting, setFieldError }) => {
        const isDropdownOrCheckbox = values.fieldType === FIELD_TYPES.DROPDOWN || values.fieldType === FIELD_TYPES.CHECKBOX;
        setIsSaving(true);
        setError(null);
        try {
    ...
    const handleDeleteAdditionalField = useCallback(async (id) => {
        setDeleteError(null);
        try {
...
//# sourceMappingURL=useLeadAdditionalCrud.js.map