...
export const additionalFieldValidationSchema = yup.object({
    ...
    dropdownValues: yup.array(yup.string().required()).test('values-required-for-dropdown-or-checkbox', ERROR_MESSAGES.VALIDATION_DROPDOWN_VALUES, function (value) {
        const fieldType = this.parent.fieldType;
        if (fieldType !== FIELD_TYPES.DROPDOWN && fieldType !== FIELD_TYPES.CHECKBOX)
            return true;
...
//# sourceMappingURL=additionalField.validation.js.map