...
function getAdditionalFieldsValidationShape(fields) {
    const shape = {};
 ...
 */
export function getAddLeadValidationSchema(additionalFields) {
    return yup.object({
        ...BASE_VALIDATION_SHAPE,
        ...getAdditionalFieldsValidationShape(additionalFields),
    });
}
//# sourceMappingURL=addLead.validation.js.map