...
const DealActionMenu = ({ isOpen, onToggle, onClose, row, onView, onEdit, onDelete, onWhatsApp, onMessage }: DealActionMenuProps) => {
    ...
    <>
      ...
      <ActionMenuPortal isOpen={isOpen} triggerRef={buttonRef} onClose={onClose}>
        <div className="deal-action-dropdown">
          <button type="button" onClick={() => { onView(row); onClose(); }}>
