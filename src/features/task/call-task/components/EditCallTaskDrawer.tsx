...
import type { EditCallTaskDrawerProps } from '../types/index';

const EditCallTaskDrawer = ({ isOpen, onClose, validationSchema, initialValues, onSubmit, isLoading, error, editingItem, staffOptions, staffLoading, leadOptions, leadLoading }: EditCallTaskDrawerProps) => {
