...
export function useFetchDealTasks() {
    const pagination = useTableData({
        fetchFn: async (params) => {
            const response = await dealTaskApiService.fetchAll({
                ...params,
                type: 'DEAL_TASK',
            });
...
//# sourceMappingURL=useFetchDealTasks.js.map