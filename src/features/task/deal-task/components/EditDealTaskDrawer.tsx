...
import type { EditDealTaskDrawerProps } from '../types/index';

const EditDealTaskDrawer = ({ isOpen, onClose, validationSchema, initialValues, onSubmit, isLoading, error, editingItem, staffOptions, staffLoading, leadOptions, leadLoading }: EditDealTaskDrawerProps) => {
