...
const AddDealTaskDrawer = ({ isOpen, onClose, validationSchema, initialValues, onSubmit, isLoading, error, staffOptions, staffLoading, leadOptions, leadLoading }) => {
