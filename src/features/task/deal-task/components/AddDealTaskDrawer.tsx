...
import type { AddDealTaskDrawerProps } from '../types/index';

const AddDealTaskDrawer = ({ isOpen, onClose, validationSchema, initialValues, onSubmit, isLoading, error, staffOptions, staffLoading, leadOptions, leadLoading }: AddDealTaskDrawerProps) => {
