...
import type { DealTaskActionsProps } from '../types/index';

const DealTaskActions = ({ item, dropdownOpen, onToggleDropdown, onEdit, onDelete }: DealTaskActionsProps) => {
...
export default DealTaskActions;
