...
export function applyFieldErrors(
  ...
  if (message) {
    ...
    if (lower.includes('description')) { setFieldError('description', message); return 'description'; }
    if (lower.includes('date')) { setFieldError('scheduledDate', message); return 'scheduledDate'; }
    if (lower.includes('time')) { setFieldError('scheduledTime', message); return 'scheduledTime'; }
  }
  return null;
}
