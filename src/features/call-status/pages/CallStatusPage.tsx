  ...
  return (
    <div className="task-settings-page">
      ...
      <div className="settings-content">
        <PageHeader title="Call Status" description="Manage call status options" />
        <div className="table-container">
          <AdminToolbar searchQuery={d.searchQuery} onSearchChange={d.setSearchQuery} onAdd={d.handleAdd} addLabel="Add Call Status" />
      ...
      <AdminFormDrawer isOpen={d.showForm} title="Call Status" fields={formFields}
