  ...
  return (
    <div className="task-settings-page">
      ...
      <div className="settings-content">
        <PageHeader title="Call Reasons" description="Manage call reason options" />
        <div className="table-container">
          <AdminToolbar searchQuery={d.searchQuery} onSearchChange={d.setSearchQuery} onAdd={d.handleAdd} addLabel="Add Reason" />
      ...
      <AdminFormDrawer isOpen={d.showForm} title="Reason" fields={formFields}
