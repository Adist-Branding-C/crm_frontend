...
const designationData: DesignationItem[] = [
  { id: 1, name: 'Manager' },
  { id: 2, name: 'Team Lead' },
];
...
const DesignationPage = () => {
  ...
  const handleEditClick = (item: DesignationItem) => {
    setShowForm(true);
    setEditingItem(item);
  ...
  const handleDeleteClick = (item: DesignationItem) => {
    ...
    <div className="account-page">
      <div className="account-layout">
        <div className="account-content" style={{ width: '100%', maxWidth: '100%' }}>
          <PageHeader
            title="Designations"
            description="Create and manage staff designations"
            action={
        ...
        <div className="drawer-overlay" onClick={handleCloseForm}>
          <div className="drawer drawer-right" onClick={(e) => e.stopPropagation()}>
            <div className="drawer-header">
              <h5>{editingItem ? 'Edit Designation' : 'Add Designation'}</h5>
