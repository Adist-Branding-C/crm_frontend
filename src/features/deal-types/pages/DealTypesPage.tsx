  ...
  return (
    <div className="deal-settings-page">
      ...
      <div className="settings-content">
        <PageHeader title="Deal Types" description="Manage deal categories" />
        <div className="table-container">
          <AdminToolbar searchQuery={d.searchQuery} onSearchChange={d.setSearchQuery} onAdd={d.handleAdd} addLabel="Add Deal Type" />
      ...
      <AdminFormDrawer isOpen={d.showForm} title="Deal Type" fields={formFields}
        formData={d.formData} onChange={d.setFormData} onSave={d.handleSave} onClose={d.handleCloseForm}
        isEditing={!!d.editingItem} />
      <AdminDeleteModal isOpen={!!d.deletingItem} itemName={d.deletingItem?.type} itemType="deal type"
