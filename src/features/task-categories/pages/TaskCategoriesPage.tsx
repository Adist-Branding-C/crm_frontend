...
import { useTaskCategoriesData } from '../hooks/useTaskCategoriesData';
  ...
  return (
    <div className="task-settings-page">
      ...
      <div className="settings-content">
        <PageHeader title="Task Categories" description="Manage task categories" />
      ...
      <AdminFormDrawer isOpen={d.showForm} title="Category" fields={formFields}
        formData={d.formData} onChange={d.setFormData} onSave={d.handleSave} onClose={d.handleCloseForm}
        isEditing={!!d.editingItem} />
      <AdminDeleteModal isOpen={!!d.deletingItem} itemName={d.deletingItem?.category} itemType="category"
