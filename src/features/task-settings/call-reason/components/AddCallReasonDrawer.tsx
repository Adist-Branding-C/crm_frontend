...
import type { AddCallReasonDrawerProps } from '../types/index';

const AddCallReasonDrawer = ({ isOpen, onClose, validationSchema, initialValues, onSubmit, isLoading, error, isEditing }: AddCallReasonDrawerProps) => {
