...
const AgentPage = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(SettingsTableLayout, { searchQuery: pagination.searchQuery, onSearchChange: pagination.handleSearchChange, onAdd: drawer.openAddDrawer, addLabel: "Add Staff", data: pagination.list, columns: AGENT_TABLE_COLUMNS, startIndex: startIndex, dropdownOpen: dropdown.dropdownOpen, onToggleDropdown: dropdown.toggleDropdown, onEdit: handleEditClick, onDelete: handleDeleteClick, currentPage: pagination.pageNumber, totalPages: totalPages, rowsPerPage: pagination.limit, totalItems: pagination.totalCount, onPageChange: pagination.setPageNumber, onRowsPerPageChange: handleRowsPerPageChange }), _jsx(AddAgentDrawer, { visibility: { isOpen: drawer.showDrawer, onClose: drawer.closeDrawer }, form: {
                ...
                }, status: { isLoading: pagination.isLoading, error: pagination.error }, designation: { options: designation.designationOptions, onFetch: designation.fetchDesignations } }), _jsx(AdminDeleteModal, { isOpen: !!deleteConfirm.deletingItem, itemName: deleteConfirm.deletingItem?.fullName || deleteConfirm.deletingItem?.name || '', onConfirm: deleteConfirm.handleConfirmDelete, onClose: deleteConfirm.closeDeleteModal }), _jsx(ToastNotification, { isVisible: toast.showToast, type: toast.toastType, message: toast.toastMessage, onDismiss: () => toast.setShowToast(false) })] }));
};
export default AgentPage;
//# sourceMappingURL=AgentPage.js.map