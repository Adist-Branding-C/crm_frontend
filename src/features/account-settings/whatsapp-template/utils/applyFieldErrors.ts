...
export function applyFieldErrors(
  ...
  if (message) {
    ...
    if (lower.includes('template') || lower.includes('template_name') || lower.includes('templateName') || lower.includes('name')) { setFieldError('templateName', message); return 'templateName'; }
  }
  return null;
}
