...
import type { AddDepartmentDrawerProps } from '../types';
              ...
              return (
                <Form>
                  ...
                  <div className="form-group">
                    ...
                    <Field type="text" name="departmentName" className={fieldClass('departmentName')} placeholder="Enter department name" />
                    <FormikError name="departmentName" component="small" className="field-error-text" />
                  </div>
