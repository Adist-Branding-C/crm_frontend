...
export function useDesignationPage() {
    ...
    const totalPages = useMemo(() => Math.ceil(designation.totalCount / designation.limit) || 1, [designation.totalCount, designation.limit]);
...
//# sourceMappingURL=useDesignationPage.js.map