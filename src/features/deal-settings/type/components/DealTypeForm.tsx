...
import { dealTypeValidationSchema } from '../validations/dealType.validation';
import { DEAL_TYPE_STATUS_OPTIONS } from '../constants/deal-type.constants';
...
interface DealTypeFormProps {
  ...
  initialValues: DealTypeFormData;
  onSubmit: (values: DealTypeFormData, helpers: FormikHelpers<DealTypeFormData>) => Promise<void | boolean>;
  isLoading: boolean;
  error: string | null;
  onCancel: () => void;
...
const DealTypeForm = ({
  ...
  return (
    <Formik
      ...
      validationSchema={dealTypeValidationSchema}
      onSubmit={onSubmit}
    >
      {({ errors, touched, dirty, submitCount, isSubmitting }) => {
        ...
        const fieldClass = (name: keyof DealTypeFormData) =>
        ...
        return (
          <Form>
            ...
            <div className="form-group">
              ...
              <Field type="text" name="name" className={fieldClass('name')} placeholder="Enter deal type name" />
            ...
            <div className="form-group">
              ...
              <Field as="select" name="status" className={fieldClass('status')}>
                ...
                {DEAL_TYPE_STATUS_OPTIONS.map(opt => (
