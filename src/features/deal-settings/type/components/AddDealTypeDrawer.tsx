...
import { nameStatusValidationSchema } from '../../shared/validations/nameStatus.validation';
...
const AddDealTypeDrawer: React.FC<AddDealTypeDrawerProps> = ({
  ...
  <AdminFormDrawer isOpen={isOpen} title="Deal Type" fields={DEAL_TYPE_FORM_FIELDS}
    ...
    onClose={onClose} isEditing={isEditing} validationSchema={nameStatusValidationSchema} />
);
