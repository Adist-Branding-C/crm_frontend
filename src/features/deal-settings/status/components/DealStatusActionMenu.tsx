...
import type { DealStatusActionMenuProps } from '../types/deal-status-action-menu.types';

const DealStatusActionMenu: React.FC<DealStatusActionMenuProps> = ({
...
export default DealStatusActionMenu;
