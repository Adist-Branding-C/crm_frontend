...
import type { DealStatusTableProps } from '../types/deal-status-table.types';

const dealStatusColumns: Column<DealStatusItem>[] = [
  { key: 'name', label: 'Name' },
  {
    key: 'status',
    label: 'Status',
    render: (item: DealStatusItem) => (
...
const DealStatusTable: React.FC<DealStatusTableProps> = ({
  ...
  <div className="table-container">
    ...
    <AdminTable data={data} columns={dealStatusColumns} startIndex={startIndex}
