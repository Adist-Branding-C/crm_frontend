...
/**
 * Validation schema for the deal status create/edit form.
 *
 * Used by:
 * - DealStatusForm (deal-settings/status)
 *
 * Notes:
 * - Extends the base name+status shape with the stage field specific to deal statuses.
