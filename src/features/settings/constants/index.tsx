...
export const settingsItems = [
  ...
  { id: 'tasks', title: 'Task Settings', description: 'Organize task categories, priorities, and customizations for improved productivity', link: '/user/task_categories', icon: <Clock size={24} /> },
