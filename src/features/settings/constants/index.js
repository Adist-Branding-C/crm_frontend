...
export const settingsItems = [
    ...
    { id: 'leads', title: 'Lead Settings', description: 'Configure status, source, purpose, and custom fields for seamless management', link: '/settings/lead-settings/types', icon: _jsx(Users, { size: 24 }) },
