...
import type { EditCampaignDrawerProps, CampaignFormData } from '../types';

const EditCampaignDrawer = ({ isOpen, onClose, validationSchema, initialValues, onSubmit, isLoading, error, editingItem, isEditing = true }: EditCampaignDrawerProps) => {
